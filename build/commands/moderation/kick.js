            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!target)
                            return [2, '⛔ Please tag someone to kick.'];
                        if (!target.kickable)
                            return [2, '⛔  Cannot kick that user.'];
                    ...
                    case 1:
                        _b.sent();
                        filter = function (buttonInteraction) {
                        ...
                        collector.on('end', function (collected) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        if (!(collected.size === 0)) return [3, 2];
                                    ...
                                    case 1:
                                        ...
                                        return [2];
                                    case 2:
                                        if (!(((_a = collected.first()) === null || _a === void 0 ? void 0 : _a.customId) === 'confirm')) return [3, 4];
                                        return [4, interaction.editReply({
                                    ...
                                    case 3:
                                        ...
                                        return [3, 6];
                                    case 4:
                                        if (!(((_b = collected.first()) === null || _b === void 0 ? void 0 : _b.customId) === 'cancel')) return [3, 6];
                                        return [4, interaction.editReply({
