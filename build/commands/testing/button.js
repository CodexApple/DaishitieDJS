                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        if (!(((_a = collected.first()) === null || _a === void 0 ? void 0 : _a.customId) === 'ban_yes')) return [3, 2];
                                        return [4, msgInt.editReply({
                                    ...
                                    case 1:
                                        ...
                                        return [3, 4];
                                    case 2:
                                        if (!(((_b = collected.first()) === null || _b === void 0 ? void 0 : _b.customId) === 'ban_no')) return [3, 4];
                                        return [4, msgInt.editReply({
